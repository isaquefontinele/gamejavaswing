...
public class Scoreboard extends JPanel {
	...
	/*
	 * Adds a new score into the array, sorts the array by score, then truncates
	 * to the top 10 scores again
	 */
	...
	/*
	 * Load the default scores, in case of it can't read the current ones
	 */
